...
def observation(agent, env):
    ...
    """
    # === Validation ===
    assert hasattr(env, "occupancy_grid")
    ...
    if env.use_conv_2d:
        ...
        obs_dict["grid_obs"] = env.occupancy_grid.internal_grid.get_grid_visits_obstacle_observation(pos, env.mini_grid_radius, mini_grid_obstacles)
